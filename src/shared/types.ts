// Shared TypeScript interfaces and types for Tascorr.
// Aligned with the database schema and PROJECT_CONSTITUTION_V5.md business rules.
...
export interface ITenant {
  id: number;
  name: string;
  subscriptionTier: number; // Tier 1, 2, 3
...
export interface IRank {
  ...
  tenantId: number;
  title: string;
  level: number; // Lower level = higher authority (e.g. 1 = executive, 6 = employee)
  createdAt: string;
  updatedAt: string;
}
...
// User object populated with rank and department information
...
// Session data transmitted in JSON Web Token (JWT)
