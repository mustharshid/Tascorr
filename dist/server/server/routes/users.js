 ...
 */
router.post('/tenant/support-access', auth_middleware_js_1.authenticateSession, auth_middleware_js_1.requireAdmin, async (req, res) => {
    const tenantId = req.user.tenantId;
    ...
    try {
        let supportAccessGrantedUntil = null;
        if (durationHours > 0) {
